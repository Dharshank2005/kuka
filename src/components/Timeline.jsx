...
const Timeline = () => {
  ...
  const timelineEvents = [
    ...
    },
    {
      ...
      description:
        "Final date to complete your team registration and submission of preliminary ideas.",
      icon: <Users size={24} />,
      color: "bg-secondary-600",
    },
    {
      date: "August First Week, 2025",
      title: "Hackathon Weekend",
      description:
        "The main event! 48 hours of intense innovation, coding, and development.",
    ...
    },
    {
      ...
      description:
        "Present your solution to our panel of judges from KUKA and industry experts.",
      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="max-w-4xl mx-auto">
          {timelineEvents.map((event, index) => (
            ...
            >
              ...
              {/* Icon */}
              <div
                className={`z-10 flex items-center justify-center w-12 h-12 rounded-full shadow-lg text-white ${event.color} shrink-0`}
              >
                {event.icon}
              </div>
        ...
        >
          <p className="text-gray-600 mb-6">
            All participants will receive detailed instructions and access to
